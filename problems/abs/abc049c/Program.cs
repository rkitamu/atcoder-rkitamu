...
class Program
{
    static void Main()
    {
        var s = StdReader.ReadSingle<string>();
        ...
        {
            if (7 <= i && s[(i - 7)..i] == dreamer)
            {
                i -= 7;
            }
            else if (5 <= i && s[(i - 5)..i] == dream)
            {
                i -= 5;
            }
            else if (6 <= i && s[(i - 6)..i] == eraser)
            {
                i -= 6;
            }
            else if (5 <= i && s[(i - 5)..i] == erase)
            {
                i -= 5;
            }
            else
            {
                StdWriter.PrintLine("NO");
                return;
            }
        }
        StdWriter.PrintLine("YES");
    }
}
